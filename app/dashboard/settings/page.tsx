  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="p-8 space-y-6 rounded-3xl">
        <div>
          <h3 className="mb-2 text-xl font-semibold tracking-tight text-foreground">Appearance</h3>
          <p className="mb-6 text-sm text-muted-foreground">Choose how HomeVault looks to you.</p>
        </div>
      ...
      <Card className="p-8 space-y-6 rounded-3xl">
        <h3 className="mb-2 text-xl font-semibold tracking-tight text-foreground">Account</h3>
      ...
      <Card className="p-8 space-y-6 rounded-3xl border-destructive/30">
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between border-b border-border py-5 last:border-0">
      <div>
