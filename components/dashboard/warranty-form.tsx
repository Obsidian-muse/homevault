      ...
      {assets && (
        <label className="block space-y-1.5">
          ...
          <select
            ...
            className="h-10 w-full rounded-lg border border-border bg-input px-3 text-sm text-foreground outline-none focus:border-primary/60 focus:ring-2 focus:ring-ring/40 focus:shadow-[0_0_0_3px_color-mix(in_oklab,var(--primary)_18%,transparent)] transition-all"
          >
            {assets.map((a) => (
  ...
  return (
    <label className="block space-y-1.5">
      ...
      <input
        ...
        className="h-10 w-full rounded-lg border border-border bg-input px-3 text-sm text-foreground outline-none placeholder:text-muted-foreground/60 focus:border-primary/60 focus:ring-2 focus:ring-ring/40 focus:shadow-[0_0_0_3px_color-mix(in_oklab,var(--primary)_18%,transparent)] transition-all"
      />
    </label>
  )
}
