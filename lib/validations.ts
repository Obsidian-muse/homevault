...
// Must match the Prisma `RoomType` enum member names (prisma/schema.prisma)
// exactly — these are the values sent to Prisma Client, not the @map()-ed
// display labels. Use `roomTypeLabel()` from lib/data.ts to render these.
